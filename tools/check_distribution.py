...
REQUIRED_PATHS = [
    ...
    "adco_resources/templates/project/AD-creative/AGENTS.md",
    ...
    "adco_resources/fixtures/content_first_forward/answer.schema.json",
    "adco_resources/fixtures/content_first_forward/answer.example.json",
    "adco_resources/fixtures/content_first_forward/brief.md",
