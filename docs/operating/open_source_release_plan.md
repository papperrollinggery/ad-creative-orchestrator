...
|---|---|---|---|
| Install/run clarity | user can start without reading code | README Quickstart, `adco --version`, `adco sample`, `adco doctor`, `adco support-bundle`, launcher, operator CLI | PASS |
...
19. Iterate on issues from real users.
