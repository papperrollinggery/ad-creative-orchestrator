...
- search_plans=1
- references=5
- plan=AD-creative/references/search_plan.md
- search_targets=3
...
- AD-creative/references/search_plan.md 仍需用户批准或缩小范围。
- REF-QLO-001 仍是搜索目标，尚无真实 URL。
- REF-QLO-002 仍是搜索目标，尚无真实 URL。
- REF-QLO-003 仍是搜索目标，尚无真实 URL。
